...
import { SafeAreaView, View, Text, Image, TouchableOpacity, ScrollView, Dimensions, Modal, FlatList, TouchableOpacityBase } from 'react-native';
...
const BrandScreen = () => {
    ...
    const getCategoryListByProduct = async () => {
        ...
        axios.post(URLs, {
            ...
            category_id: params?.params?.item?.id
        })
            .then((response) => {
            ...
            .catch((err) => {
                console.log("err in getCategoryListByProduct", err);
            });
    }
