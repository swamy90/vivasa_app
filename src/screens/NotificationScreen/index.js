...
import FruitsItems from "../../components/fruitItems";
...
export default class NotificationScreen extends React.Component {
    ...
    constructor(props) {
        super(props);
        this.state = {
            notification: [{ id: 1, name: 'Fresh Foods', des: '26 - 27 june on selected Fruits, Vegetables, Dry Fruits.', time: 'Just Now' }, { id: 1, name: 'Fresh Foods', des: '26 - 27 june on selected Fruits, Vegetables, Dry Fruits.', time: 'Just Now' }],
        }
    }
        ...
        return (
            <SafeAreaView>
                <View style={{ backgroundColor: 'rgb(239,244,250)', height: '100%' }}>
                    <View style={{
                        backgroundColor: '#222222', borderBottomLeftRadius: 20, borderBottomRightRadius: 20, flexDirection: 'row', alignItems: 'center', padding: 20, shadowColor: '#b4b4b4',
                        shadowOffset: { width: 0, height: 2 },
                        shadowOpacity: 0.8,
                        shadowRadius: 2,
                        elevation: 5,
                        ...
                        <Text style={{ flex: 1, textAlign: 'center', color: '#FFFFFF', fontSize: 17, marginRight: 30, letterSpacing: 1.5, fontWeight: 'bold' }}>Notification</Text>
                        <View>
                            <Image
                    ...
                    <View style={{ padding: 10, marginTop: 10 }}>
                        <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 15 }}>
                            ...
                            <TouchableOpacity style={{ flexDirection: 'row', alignItems: 'center' }}>
                                <Text style={{ marginRight: 2, color: '#222222', fontWeight: 'bold' }}>View All</Text>
                                <Image style={{ width: 12, height: 12, resizeMode: 'contain', tintColor: '#222222' }} source={require('../../assets/images/noti-arrow.png')} />
                            </TouchableOpacity>
                        </View>
                        <View>
                            <FlatList
