...
import { View, Image, Dimensions, Modal, StyleSheet, Animated, Platform, TouchableOpacity, ImageSourcePropType,Text } from 'react-native'
...
import { Image_Files_URL } from '../../../src/global'
                    ...
                    renderItem={({ item, index }) => {
                        ...
                        return (
                            <View
                                ...
                                <Text>{Image_Files_URL + item?.img}</Text>
                                <Image
                                    // @ts-ignore
                                    source={localImg ? item?.image : { uri: Image_Files_URL + item?.image }}
