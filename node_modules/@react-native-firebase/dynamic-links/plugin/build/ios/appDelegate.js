...
function modifyObjcAppDelegate(contents) {
    // Add import
    if (!contents.includes('#import <RNFBDynamicLinksAppDelegateInterceptor.h>')) {
...
#import <RNFBDynamicLinksAppDelegateInterceptor.h>`);
    ...
    if (!methodInvocationLineMatcher.test(contents) &&
        ...
        config_plugins_1.WarningAggregator.addWarningIOS('@react-native-firebase/dynamic-links', 'Unable to determine correct Firebase insertion point in AppDelegate.m. Skipping Firebase addition.');
        return contents;
    }
    // Add invocation
    try {
